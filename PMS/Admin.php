...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#99CCFF">
      ...
      <th width="11%" scope="col"><a href="ADMIN/faculty.php">Add Supervisor</a></th>
      <th width="11%" scope="col"><a href="ADMIN/stsearch.php">Search Student</a></th>
      <th width="11%" scope="col"><a href="ADMIN/fa_search.php">Search supervisor </a></th>
...
<body>
  ...
  <tr bgcolor="#2536df">
    <th width="74" scope="col">&nbsp;</th>
    <th width="164" scope="col"><img src="images/logo1.png" alt="LOGO"></th>
    <th width="646" scope="col"><font size="8" color="White">Project Information Managenent System</font></th>
    <th width="140" scope="col"><font color="White" size="5">
    <?php
    print $role;
    echo "<br/>";
  ...
  <table width="100%" border="0" cellspacing="00" cellpadding="00">
      ...
      <th width="13%" scope="col"><a href="FACULTY/meeting.php">Meeting/pannel</a></th>
