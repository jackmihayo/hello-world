...
<body>
  ...
  <tr bgcolor="#99CCFF">
    ...
    <th width="13%" scope="col"><a href="meeting.php">Meeting/Pannel</a></th>
    <th width="15%" scope="col"><a href="#">Reports</a></th>
...
<table width="100%" border="0" cellspacing="05" cellpadding="05">
  <tr>
    ...
    <th colspan="2" scope="col"><font size="6">MEETING/PANNEL DETAIL</font></th>
    <th width="12%" rowspan="2" scope="col">&nbsp;</th>
  </tr>
  <tr>
      <td width="36%" scope="col" align="right"><font size="5">Supervisor ID : </font></th>
