    ...
    if(in_array($file_ext, $allowed))
    {
        if($file_error===0)
        {
            if($file_size<=9999999999)
            {
                ...
                $file_destination='../ppf/';
                if(move_uploaded_file($file_temp, $file_destination.$file_name))
                {
...
<table width="100%" border="0" cellspacing="05" cellpadding="05">
  ...
  <tr>
    ...
    <td align="center"><div style="background-color: beige;"><br/><h3>Project  Specifications</h3><br /><input type="file" name="psf"/><br/><br/><input type="submit" name="bpsf" value="upload"/><br/><br/></div></td>
    <td>&nbsp;</td>
  </tr>
</form>
</table>
