...
<title>Project Information Management System</title>
</head>
<div>
<body>
...
<table width="100%" border="0" cellspacing="01" cellpadding="01">
  ...
  <tr>
    ...
    <td>
      <select name="stream" style="width: 13em; height: 2em; font-size: 15px; ">
         <option value="Select">Select</option>
         <option value="CE" <?php if($row['stream']=='CE') echo 'selected="selected"'; ?>>CE</option>
        ...
        <option value="EE" <?php if($row['stream']=='EE') echo 'selected="selected"'; ?>>EE</option> 
         <option value="ETE" <?php if($row['stream']=='ETE') echo 'selected="selected"'; ?>>ETE</option> 
          <option value="MFT" <?php if($row['stream']=='MFT') echo 'selected="selected"'; ?>>MFT</option>
           <option value="ME" <?php if($row['stream']=='ME') echo 'selected="selected"'; ?>>ME</option>
            <option value="RATE" <?php if($row['stream']=='RATE') echo 'selected="selected"'; ?>>RATE</option> 
             <option value="FST" <?php if($row['stream']=='FST') echo 'selected="selected"'; ?>>FST</option>       
        </select>
      </td>
    <td>&nbsp;</td>
  </tr>
